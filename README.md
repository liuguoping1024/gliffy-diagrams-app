...
**Windows**: Download and double-click `pake.exe` to run. All resources are bundled inside the executable — no installation needed.

Alternatively, install via the MSI installer from [Releases](https://github.com/liuguoping1024/gliffy-diagrams-app/releases).
...
- [Pake](https://github.com/tw93/Pake) — A lightweight tool for turning any webpage into a desktop app, powered by Tauri. This project would not exist without it.
